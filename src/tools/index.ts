...
import { tool as dockerComposePrettify } from './docker-compose-prettify';
...
import { tool as customEncryptionJsonViewer } from './custom-encryption-json-viewer';
...
export const toolsByCategory: ToolCategory[] = [
  {
    name: 'Crypto',
    components: [customEncryptionJsonViewer, tokenGenerator, hashText, bcrypt, uuidGenerator, ulidGenerator, cypher, bip39, hmacGenerator, rsaKeyPairGenerator, passwordStrengthAnalyser, pdfSignatureChecker],
  },
  {
    name: 'Converter',
    components: [
